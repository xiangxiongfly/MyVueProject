var Vue = (function(exports) {
	...
	function createDevtoolsComponentHook(hook) {
		return (component) => {
			emit$1(hook, component.appContext.app, component.uid, component.parent ? component.parent.uid :
				undefined, component);
		};
	}
	...
	function devtoolsComponentEmit(component, event, params) {
		emit$1("component:emit" /* DevtoolsHooks.COMPONENT_EMIT */ , component.appContext.app, component, event,
			params);
	}
	...
	function doWatch(source, cb, {
		...
		const instance = getCurrentScope() === (currentInstance === null || currentInstance === void 0 ?
			void 0 : currentInstance.scope) ? currentInstance : null;
	...
	*/
	...
	function cloneVNode(vnode, extraProps, mergeRef = false) {
		...
		const cloned = {
			...
			patchFlag: extraProps && vnode.type !== Fragment ?
				...
				patchFlag | 16 /* PatchFlags.FULL_PROPS */ : patchFlag,
		...
		if (!context.inVPre && /^(v-[A-Za-z0-9-]|:|\.|@|#)/.test(name)) {
			...
			if (match[2]) {
				...
				arg = {
					...
					isStatic,
					constType: isStatic ?
						3 /* ConstantTypes.CAN_STRINGIFY */ : 0 /* ConstantTypes.NOT_CONSTANT */ ,
					loc
				};
			}
	...
	function validateBrowserExpression(node, context, asParams = false, asRawStatements = false) {
		...
		try {
			...
			context.onError(createCompilerError(45 /* ErrorCodes.X_INVALID_EXPRESSION */ , node.loc, undefined,
				message));
		}
	}
		...
		if (arg.type === 4 /* NodeTypes.SIMPLE_EXPRESSION */ ) {
			if (arg.isStatic) {
				...
				const eventString = node.tagType !== 0 /* ElementTypes.ELEMENT */ ||
					...
					!/[A-Z]/.test(
						rawName) ? // for non-element and vnode lifecycle event listeners, auto convert
	...
	const transformModel = (dir, node, context) => {
		...
		if (dir.arg) {
			context.onError(createDOMCompilerError(56 /* DOMErrorCodes.X_V_MODEL_ARG_ON_ELEMENT */ , dir.arg
				.loc));
		}
		...
		function checkDuplicatedValue() {
			...
			if (value) {
				context.onError(createDOMCompilerError(58 /* DOMErrorCodes.X_V_MODEL_UNNECESSARY_VALUE */ ,
					value.loc));
			}
		}
		const {
		...
		if (tag === 'input' ||
						...
						switch (type.value.content) {
							...
							case 'file':
								...
								context.onError(createDOMCompilerError(
									57 /* DOMErrorCodes.X_V_MODEL_ON_FILE_INPUT_ELEMENT */ , dir.loc
								));
								break;
							default:
								// text type
			...
			context.onError(createDOMCompilerError(55 /* DOMErrorCodes.X_V_MODEL_ON_INVALID_ELEMENT */ , dir
				.loc));
		}
	...
	const ignoreSideEffectTags = (node, context) => {
		if (node.type === 1 /* NodeTypes.ELEMENT */ &&
			...
			context.onError(createDOMCompilerError(61 /* DOMErrorCodes.X_IGNORED_SIDE_EFFECT_TAG */ , node
				.loc));
			context.removeNode();
		}
	};
